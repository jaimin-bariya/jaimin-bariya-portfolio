...
const Persona = ({personaList=[]}) => {
  return (
    ...
    <Tabs defaultValue="account" className=" bg-transparent w-full  h-[400px] ">
              ...
              {personaList.map((thing, index) => (
                ...
                <div className="w-full h-fit min-h-24 bg-gray-800/30 border-white flex rounded-2xl gap-2 p-2   ">
                  ...
                  <div className="flex flex-col w-full gap-1">
                    ...
                    <p className="border-b-2 w-fit pb-1 pr-2 border-black text-white">{thing}</p>
                    <p className="text-base">fcvgnj fghjk drfghj4e5r6ty ftge hj g   fcvgnj fghjk drfghj4e5r6ty ftge hj g   
                      fcvgnj fghjk drfghj4e5r6ty ftge hj g   fcvgnj fghj
                      k drfghj4e5r6ty ftge hj g   </p>
                  </div>
                </div>
                </div>
              ))}
