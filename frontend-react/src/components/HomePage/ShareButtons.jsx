    ...
    <>
      <div className={`${className}`}>
        <Card className="bg-gray-800/20 w-[450px] backdrop-blur-lg p-3 rounded-3xl hover:bg-gray-800/40 transition-colors cursor-pointer group">
          {shareHeading ? (
            <h1 className="animate-slideInLeft font-extrabold font-mono text-xl w-full text-center pb-4">
              {shareHeading}
            </h1>
          ) : (
            ""
          ...
          <div className={`flex justify-around `}>
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
                  <div
                    className={`h-10 w-10 transform  opacity-0  transition-all duration-1000  ease-out delay-1000 ${
                      isVisible
                  ...
                  >
                    <a
                      href="https://github.com/jaimin-bariya"
                      target="_blank"
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
                  <div
                    className={`h-10 w-10 transform  opacity-0  transition-all duration-700  ease-out delay-700 ${
                      isVisible
                        ? "translate-x-0  opacity-100"
                        : "-translate-x-10 opacity-0"
                    }`}
                  >
                    <a
                      href="https://www.instagram.com/jaiminbariya_"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
                  <div
                    className={`h-10 w-10 transform  opacity-0  transition-all duration-500  ease-out delay-500 ${
                      isVisible
                        ? "translate-x-0  opacity-100"
                        : "-translate-x-10 opacity-0"
                    }`}
                  >
                    <a
                      href="https://x.com/jaiminbariya_"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
                  <div
                    className={`h-10 w-10 transform  opacity-0  transition-all duration-300  ease-out delay-300 ${
                      isVisible
                        ? "translate-x-0  opacity-100"
                        : "-translate-x-10 opacity-0"
                    }`}
                  >
                    <a
                      href="https://www.linkedin.com/in/jaiminbariya/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
                  <div
                    className={`h-10 w-10 transform  opacity-0  transition-all duration-200  ease-out delay-200 ${
                      isVisible
                        ? "translate-x-0  opacity-100"
                        : "-translate-x-10 opacity-0"
                    }`}
                  >
                    <a
                      href="https://leetcode.com/u/jaimin-bariya/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
                  <div
                    className={`h-10 w-10 transform  opacity-0  transition-all duration-100  ease-out delay-100 ${
                      isVisible
                        ? "translate-x-0  opacity-100"
                        : "-translate-x-10 opacity-0"
                    }`}
                  >
                    <a
                      href="https://www.hackerrank.com/profile/jaiminbariyastu1"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
