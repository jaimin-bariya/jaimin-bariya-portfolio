    ...
    <>
        ...
        <div className=" flex flex-col gap-4 mb-6 mr-2">
            {CompetitionNames.map((competition, index) => (
                <a href={competition.link} key={index} className="flex justify-between border p-2 mx-2 dark:text-white font-normal text-black hover:text-black rounded-lg hover:shadow-orange-500 hover:shadow-md duration-700">
