const myBucketList = [
        ...
        Types: [
...

            {
                ...
                list: [
                    ...
                    {
                      action: "Complete a perfect Jefferson Curl with full range of motion",
                      isDone: false,
                      haveSideMSG: false,
    ...
    // 2 - Life Skills Bucket List 🧠
    {
        ...
        list: [
            ...
            {
              action: "Learn driving → Bike, Car, Tractor, Truck, Plane (Cessna 172 Skyhawk, Cirrus SR22) 🚗✈️",
              isDone: false,
              haveSideMSG: true,
              message: "Bike ✔️, "
            }
    ...
    {
        name: "Travel & Adventure Bucket List (Bharat)",
        haveSubTypes: true,
        Types:[
            {
                ...
                list: [
                    ...
                    {
                      action: "Manali (Himachal Pradesh)",
                      isDone: false,
                      haveSideMSG: false,
                      message: ""
                    },
                    {
                      action: "Spiti Valley (Himachal Pradesh)",
                      isDone: false,
                      haveSideMSG: false,
                      message: ""
                    },
                    {
                      action: "Shimla (Himachal Pradesh)",
                      isDone: false,
                      haveSideMSG: false,
                      message: ""
                    }
...

            {
                ...
                list: [
                    ...
                    {
                      action: "Jaipur (Rajasthan)",
                      isDone: false,
                      haveSideMSG: false,
                      message: ""
                    },
                    {
                      action: "Agra (Uttar Pradesh)",
                      isDone: false,
                      haveSideMSG: false,
                      message: ""
                    }
...

            {
                ...
                list: [
                    ...
                    {
                      action: "Nainital (Uttarakhand) → Boating and trekking around the scenic Naini Lake 🚤",
                      isDone: false,
                      haveSideMSG: false,
                      message: ""
                    }
        ...
        Types: [
...

            {
                ...
                list: [
                    ...
                    {
                        action: "Contribute to Medium Level OSP",
                        isDone: false,
                        haveSideMSG: false,
                        message: ""
                    },
                    {
                        action: "Contribute to OSP that is supported by Big Giant",
                        isDone: false,
                        haveSideMSG: false,
                        message: ""
                    },
            ...
            {
                name: "Leetcode Questions (with understanding)",
                list: [
                    {
                      action: "50 questions",
                      isDone: false,
                    ...
                    {
                      action: "100 questions",
                      isDone: false,
                      haveSideMSG: false,
                      message: ""
                    },
                    {
                      action: "200 questions",
                      isDone: false,
                      haveSideMSG: false,
                      message: ""
                    },
                    {
                      action: "500+ questions",
                      isDone: false,
                      haveSideMSG: false,
                      message: ""
                    }
...

            {
                ...
                list: [
                    ...
                    {
                      action: "Achieve rank in the top 10",
                      isDone: false,
                      haveSideMSG: false,
                      message: ""
                    },
            ...
            {
                name: "Participate in weekly, monthly, and yearly competitions",
                list: [
                    {
                      action: "Take part in competitions",
                      isDone: false,
                      haveSideMSG: false,
                      message: ""
                    },
