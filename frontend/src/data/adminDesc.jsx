const introHomePage = (
  <>
    ...
    where I share my little but interesting journey. I’m an AI/ML Developer,
    web enthusiast, and tech lover.
    <br />
    <br />
    In my free time, I love watching anime, movies, building SAAS projects,
    creating dev tools, playing with DSA, and writing articles. I’m also
...
export {introHomePage, introAboutPage}